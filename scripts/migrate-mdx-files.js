...
function extractMarkdownContent(content) {
  console.log('Extracting content from MDX file...');
  ...
  console.log('Found content after default export');
  ...
  if (trimmedContent.length < 50) {
    console.log(`Content preview: "${trimmedContent}"`);
  } else {
    console.log(`Content preview: "${trimmedContent.substring(0, 50)}..."`);
  }
