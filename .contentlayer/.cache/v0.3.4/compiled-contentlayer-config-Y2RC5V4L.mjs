...
// lib/metadata.ts
var BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || `https://${process.env.VERCEL_URL}` || `http://localhost:${process.env.PORT || 3e3}`;
var defaultAuthor = {
  name: "Martin Ouimet",
  handle: "@InfinisoftI",
  socialProfiles,
...
//# sourceMappingURL=compiled-contentlayer-config-Y2RC5V4L.mjs.map
