...
export const article = {
  title:
    'Building a Real-World Application with @brainstack/inject: A Step-by-Step Tutorial',
  description:
    'Learn how to build a real-world application using @brainstack/inject, demonstrating its features and benefits in a practical scenario.',
