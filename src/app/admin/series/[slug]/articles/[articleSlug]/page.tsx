    ...
    return (
      <div>
        <div className="flex justify-between items-center mb-6">
          ...
          <Link
            href={`/admin/series/${seriesSlug}/articles/${articleSlug}/edit`}
        ...
        <div className="bg-white dark:bg-zinc-800 shadow overflow-hidden rounded-lg mb-8">
          ...
          <div className="border-t border-zinc-200 dark:border-zinc-700 px-4 py-5 sm:p-6">
            <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
              <div>
                <dt className="text-sm font-medium text-zinc-500 dark:text-zinc-400">Series</dt>
                <dd className="mt-1 text-sm text-zinc-900 dark:text-zinc-100">
                  <Link href={`/admin/series/${seriesSlug}`} className="text-teal-600 hover:text-teal-900 dark:text-teal-400 dark:hover:text-teal-300">
                    {seriesSlug}
                  </Link>
                </dd>
              </div>
        ...
        <div className="bg-white dark:bg-zinc-800 shadow overflow-hidden rounded-lg">
          ...
          <div className="border-t border-zinc-200 dark:border-zinc-700 px-4 py-5 sm:p-6">
            <Link
              href={`/series/${seriesSlug}/${articleSlug}`}
