...
import { GET as cronNewsletterSender } from '@/app/api/cron/newsletter-sender/route';

// This is a test endpoint to manually trigger the newsletter sender
...
export async function GET(request: Request) {
  ...
  return cronNewsletterSender(mockRequest);
}
