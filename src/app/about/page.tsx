...
export const metadata: Metadata = {
  title: 'About',
  description:
    'I’m Martin Ouimet. I live in Quebec Canada, where I design the future.',
}
...
<footer>- Thomas Edison</footer>
        ...
        <div className="lg:pl-20">
          <ul role="list">
            <SocialLink target='_blank' href="https://x.com/InfinisoftI"  icon={XIcon}>
              Follow on X
            </SocialLink>
            <SocialLink  target='_blank' 
              href="https://github.com/mouimet-infinisoft" icon={GitHubIcon} className="mt-4">
              Follow on GitHub
            </SocialLink>
            <SocialLink              target='_blank' 
              href="https://www.linkedin.com/in/mouimet-infinisoft/" icon={LinkedInIcon} className="mt-4">
              Follow on LinkedIn
            </SocialLink>
            <SocialLink
             target='_blank' 
              href="mailto:mouimet@infinisoft.world"
              icon={MailIcon}
