...
export const article = {
  ...
  description: 'Learn how to extend InfiniCode\'s functionality through custom extensions and plugins, with patterns for integration and communication.',
  series: {
...
# Extending InfiniCode: Building Custom Extensions
