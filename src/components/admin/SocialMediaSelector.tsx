...
export function SocialMediaSelector({ linkedin, twitter, facebook, devto, onChange }: SocialMediaSelectorProps) {
  const handleChange = (platform: string, checked: boolean) => {
    onChange(platform, checked);
  };
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap gap-4">
        ...
        <SocialMediaCheckbox
          ...
          label="Facebook"
          checked={facebook}
          onChange={(e) => handleChange('facebook', e.target.checked)}
          icon={
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <SocialMediaCheckbox
          ...
          label="DEV.to"
          checked={devto}
          onChange={(e) => handleChange('devto', e.target.checked)}
          icon={
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
